...
def get_config():
    ...
    # common settings
    parser.add_argument("--backbone", type=str, default="resnet50_normalize", help="see _network.py")
    ...
    # special settings
    parser.add_argument("--alpha", type=float, default=0.2, help="margin of separation")
    parser.add_argument("--beta", type=float, default=1.2, help="boundary between positive and negative pairs")
    parser.add_argument("--beta_lr", type=float, default=0.1, help="learning rate of beta")
    # only for R-Margin
    parser.add_argument("--p_switch", type=float, default=0.0, help="probability to replace a negative with a positive")
    ...
    # R-Margin
    # args.backbone = "resnet50_frozen_normalize"
    # args.batch_size = 128
    # args.beta_lr = 5e-4
    # args.p_switch = 0.1
